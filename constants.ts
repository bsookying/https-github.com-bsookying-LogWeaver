...
export const STORIES: Story[] = [
    { "id": "story_01", "name": "Spearphishing Leads to Cloud Compromise", "description": "JBorn on workstation The-Boss (10.2.0.44) is tricked by a spearphishing email, leading to credential theft from the endpoint. The attacker leverages these credentials to access the cloud environment, bypassing MFA, and exfiltrates sensitive financial data via a web service.", "actors": ["victim_user", "attacker_ip", "victim_ip", "attacker_domain", "hostname"], "stages": [ { "name": "Initial Phishing Email", "domain": "Email", "techniqueId": "T1566" }, { "name": "Credential Dumping from Endpoint", "domain": "Endpoint", "techniqueId": "T1003" }, { "name": "Login with Valid Credentials", "domain": "Identity", "techniqueId": "T1078" }, { "name": "Cloud Console Login without MFA", "domain": "Cloud", "techniqueId": "T1078" }, { "name": "Data Exfiltration via Web Service", "domain": "Network", "techniqueId": "T1567" } ] },
